...
public class CodeGeneratorUtils {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wllblog?allowMultiQueries=true&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
        dsc.setDriverName("com.mysql.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("jxswll-123");
        mpg.setDataSource(dsc);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.wllnb.wllblog.manage");
        ...
        InjectionConfig cfg = new InjectionConfig() {
            ...
            public void initMap() {
                ...
                map.put("basePath","com.wllnb.wllblog");
                this.setMap(map);
            }
        };
        ...
        strategy.setSuperControllerClass("com.wllnb.wllblog.manage.sys.controller.AbstractController");
