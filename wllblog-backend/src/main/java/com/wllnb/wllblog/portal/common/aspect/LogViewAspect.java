...
import com.wllnb.wllblog.mapper.log.LogViewMapper;
...
public class LogViewAspect {
    ...
    @Pointcut("@annotation(com.wllnb.wllblog.portal.common.annotation.LogView)")
    ...
    private void saveViewLog(ProceedingJoinPoint joinPoint, long time) {
        ...
        com.wllnb.wllblog.entity.log.LogView viewLogEntity = new com.wllnb.wllblog.entity.log.LogView();
